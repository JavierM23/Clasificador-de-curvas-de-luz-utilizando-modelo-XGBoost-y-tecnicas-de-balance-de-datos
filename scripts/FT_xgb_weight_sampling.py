...
from functions.preprocessing import get_data2, new_get_data2, LabelEncoder, class_data, weights_compute
...
for train_index, test_index in sss.split(X_hierarchical, Y_original):
    ...
    if i>=iteration:
        ...
        for over_kind in over_array:
            ...
            file_name = save_carpet + 'xgb_FT_'+subclass.lower()+'_weight_'+under_kind+'_'+over_kind+'_'+metric_name+'_model_CV_dict.pkl'
